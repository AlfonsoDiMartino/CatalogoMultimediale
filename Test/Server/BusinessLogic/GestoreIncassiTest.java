...
class GestoreIncassiTest {
	...
	@Test
	void test_GI01() {
		ArrayList<CatalogoUtente> lista = (ArrayList<CatalogoUtente>) GestoreIncassi.getListaUtentiPremium();
		assertNotNull(lista);;
		assertEquals(lista.size(), 1);
		assertEquals(lista.get(0).getId().toString(), Integer.toString(29));
	}
}