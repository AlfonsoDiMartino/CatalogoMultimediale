...
class AutoreTest {
	...
	@Test
	void test_A01() {
		ArrayList<Autore> lista = (ArrayList<Autore>) ListaAutori.getListaAutori();
		assertNotNull(lista);
	...
	@Test
	void test_A02() {
		Autore autorenull = ListaAutori.getAutoreById(14);
		assertNull(autorenull);
	}

	@Test
	void test_A03() {
		assertNull(ListaAutori.getAutoreById(null));
	}
	...
	void test_A04() {
		...
		assertEquals(autore.getNome(), "Ennio");
		assertEquals(autore.getCognome(), "Morricone");
	}

	@Test
	void test_A05() {
		assertEquals(ListaAutori.addAutore("Freddie", "Mercury"), true);
		
		Autore autorefetched = ListaAutori.getAutoreById(1);
