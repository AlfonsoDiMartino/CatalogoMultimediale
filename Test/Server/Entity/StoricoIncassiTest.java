...
import Server.Entity.DataAcquisto;
import Server.Entity.DataNoleggio;
import Server.Entity.ListaCataloghiUtenti;
import Server.Entity.StoricoIncassi;

class StoricoIncassiTest {
	...
	@Test
	void test_S01() {
		assertEquals(StoricoIncassi.getListaDateAcquistoAnnoSolare(null).isEmpty(), true);
	}
	
	@Test
	void test_S02() {
		DateFormat format = new SimpleDateFormat("dd/MM/yyyy");
		CatalogoUtente catalogoutente = ListaCataloghiUtenti.getCatalogoUtenteById(27);
		assertNotNull(catalogoutente);
		ArrayList<DataAcquisto> lista = (ArrayList<DataAcquisto>) StoricoIncassi.getListaDateAcquistoAnnoSolare(catalogoutente);
		assertNotNull(lista);
		
		assertEquals(lista.size(), 1);
		assertEquals(format.format(lista.get(0).getData()), "22/02/2018");
	}
	
	@Test
	void test_S03() {
		assertEquals(StoricoIncassi.getListaDateAcquistoPerMese(null).isEmpty(), true);
	}
	
	@Test
	void test_S04() {
		DateFormat format = new SimpleDateFormat("dd/MM/yyyy");
		ArrayList<DataAcquisto> lista = (ArrayList<DataAcquisto>) StoricoIncassi.getListaDateAcquistoPerMese(2);
		assertNotNull(lista);
		
		assertEquals(lista.size(), 4);
		assertEquals(lista.get(0).getRisorsa().getId().toString(), Integer.toString(23));
		assertEquals(format.format(lista.get(0).getData()), "22/02/2018");
		
		assertEquals(lista.get(1).getRisorsa().getId().toString(), Integer.toString(15));
		assertEquals(format.format(lista.get(1).getData()), "22/02/2018");
		
		assertEquals(lista.get(2).getRisorsa().getId().toString(), Integer.toString(19));
		assertEquals(format.format(lista.get(2).getData()), "22/02/2018");
		
		assertEquals(lista.get(3).getRisorsa().getId().toString(), Integer.toString(53));
		assertEquals(format.format(lista.get(2).getData()), "22/02/2018");
	}
	
	@Test
	void test_S05() {
		ArrayList<DataAcquisto> lista = (ArrayList<DataAcquisto>) StoricoIncassi.getListaDateAcquistoPerMese(3);
		assertNotNull(lista);
	...
	@Test
	void test_S06() {
		assertEquals(StoricoIncassi.getListaDateNoleggioPerMese(null).isEmpty(), true);
	}
	
	@Test
	void test_S07() {
		DateFormat format = new SimpleDateFormat("dd/MM/yyyy");
		ArrayList<DataNoleggio> lista = (ArrayList<DataNoleggio>) StoricoIncassi.getListaDateNoleggioPerMese(2);
		assertNotNull(lista);
		
		assertEquals(lista.size(), 3);
		assertEquals(lista.get(0).getRisorsa().getId().toString(), Integer.toString(21));
		assertEquals(format.format(lista.get(0).getData()), "22/02/2018");
		assertEquals(lista.get(1).getRisorsa().getId().toString(), Integer.toString(20));
		assertEquals(format.format(lista.get(1).getData()), "22/02/2018");
		assertEquals(lista.get(2).getRisorsa().getId().toString(), Integer.toString(23));
		assertEquals(format.format(lista.get(2).getData()), "22/02/2018");
	}
	
	@Test
	void test_S08() {
		ArrayList<DataNoleggio> lista = (ArrayList<DataNoleggio>) StoricoIncassi.getListaDateNoleggioPerMese(3);
		assertNotNull(lista);
		assertEquals(lista.isEmpty(), true);
	}
}
