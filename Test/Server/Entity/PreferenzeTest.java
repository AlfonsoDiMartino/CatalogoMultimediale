...
class PreferenzeTest {
	...
	@Test
	void test_P01() {
		assertEquals(ListaPreferenze.getListaPreferenzeUtente(null).isEmpty(), true);
	}
	...
	void test_P02() {
		...
		ArrayList<PreferenzaUtente> lista = (ArrayList<PreferenzaUtente>) ListaPreferenze.getListaPreferenzeUtente(utente);
		assertNotNull(lista);
	...
	void test_P04() {
		...
		assertEquals(ListaPreferenze.aggiungiPreferenza(null, autore, tipologia), false);
		assertEquals(ListaPreferenze.aggiungiPreferenza(utente, null, tipologia), false);
		assertEquals(ListaPreferenze.aggiungiPreferenza(utente, autore, null), false);
