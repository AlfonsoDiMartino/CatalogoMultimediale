...
class UtenteTest {
	...
	@Test
	void test_U01() {
		ArrayList<CatalogoUtente> lista = (ArrayList<CatalogoUtente>) ListaCataloghiUtenti.getListaCatalogoUtenti();
		assertNotNull(lista);
		
		assertEquals(lista.size(), 3);
		assertEquals(lista.get(0).getId().toString(), Integer.toString(27));
		assertEquals(lista.get(1).getId().toString(), Integer.toString(28));
		assertEquals(lista.get(2).getId().toString(), Integer.toString(29));
	}

	@Test
	void test_U02() {
		assertNull(ListaCataloghiUtenti.getUtenteById(null));
	}

	@Test
	void test_U03() {
		assertNull(ListaCataloghiUtenti.getUtenteById(999));
	}

	@Test
	void test_U04() {
		Utente utente = ListaCataloghiUtenti.getUtenteById(24);
		assertNotNull(utente);
		
		assertEquals(utente.getNome(), "Salvatore");
		assertEquals(utente.getCognome(), "Barone");
		assertEquals(utente.getEmail(), "salvatorebarone@email.com");
		assertEquals(utente.getPassword(), "passw0rd");
	}

	@Test
	void test_U05() {
		assertNull(ListaCataloghiUtenti.getCatalogoUtenteById(null));
	}

	@Test
	void test_U06() {
		assertNull(ListaCataloghiUtenti.getCatalogoUtenteById(9999));
	}
	...
	void test_U07() {
		...
		assertEquals(catalogo.getUtente().getId().toString(), Integer.toString(24));
		assertEquals(catalogo.getListaRisorsePossedute().size(), 2);
		assertEquals(catalogo.getListaRisorsePossedute().get(0).getId().toString(), Integer.toString(18));
		assertEquals(catalogo.getListaRisorsePossedute().get(1).getId().toString(), Integer.toString(23));
	}
	...
	void test_U08() {
		CatalogoUtente catalogo = ListaCataloghiUtenti.getCatalogoUtenteById(27);
		assertNotNull(catalogo);
		Risorsa risorsa = CatalogoMultimediale.getRisorsaById(17);
		assertNotNull(risorsa);
		
		catalogo.addRisorsa(risorsa);
		catalogo.update();
		
		CatalogoUtente catalogo2 = ListaCataloghiUtenti.getCatalogoUtenteById(27);
		assertNotNull(catalogo2);
		assertEquals(catalogo2.getUtente().getId().toString(), Integer.toString(24));
		assertEquals(catalogo2.getListaRisorsePossedute().size(), 3);
		assertEquals(catalogo2.getListaRisorsePossedute().get(0).getId().toString(), Integer.toString(17));
		assertEquals(catalogo2.getListaRisorsePossedute().get(1).getId().toString(), Integer.toString(18));
		assertEquals(catalogo2.getListaRisorsePossedute().get(2).getId().toString(), Integer.toString(23));
	}
	...
	void test_U10() {
		Utente utente = ListaCataloghiUtenti.getUtenteById(24);
		assertNotNull(utente);
		CatalogoUtente catalogo = utente.getCatalogo();
		
		assertNotNull(catalogo);
		assertEquals(catalogo.getUtente().getId().toString(), Integer.toString(24));
		assertEquals(catalogo.getListaRisorsePossedute().size(), 3);
		assertEquals(catalogo.getListaRisorsePossedute().get(0).getId().toString(), Integer.toString(17));
		assertEquals(catalogo.getListaRisorsePossedute().get(1).getId().toString(), Integer.toString(18));
		assertEquals(catalogo.getListaRisorsePossedute().get(2).getId().toString(), Integer.toString(23));
	}
